    ...
    <>
      <div
        className={`fixed top-0 h-[100%] transition-all duration-700 ease-in-out ${
          show
            ? "w-[100%] right-0 bg-primary opacity-50 backdrop-blur-md transition-all duration-500 ease-in-out"
            : "w-[100%] right-[-100%] bg-primary opacity-50 transition-all delay-200 duration-[900ms] ease-in-out "
        }`}
      ></div>
      <div
        className={`fixed h-[100%] top-0 z-20 lg:hidden flex flex-col items-center justify-between text-primary px-[2rem] pt-[6rem] pb-6 transition-all duration-[1000ms] ease-in-out  ${
          show
            ? "w-[80%] right-0 z-30 delay-400 bg-[white] backdrop-blur-md duration-[1000ms] ease-in-out"
            : "z-30 right-[-100%] bg-white transition-all duration-[1000ms] ease-in-out"
        }`}
      >
