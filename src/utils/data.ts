...
export const equipmentData: IEquipment[] = [
  {
    ...
    path: "test-seperator",
    info: "A test separator is a vital piece of process equipment used in the oil and gas industry to separate well fluids into gas, oil, and water components for accurate measurement and analysis. It plays a crucial role in evaluating well performance, determining production rates, and assessing reservoir characteristics. We specialize in providing detailed design solutions for test separators, ensuring optimal performance, reliability, and compliance with industry standards. Our experienced engineers utilize advanced design software and adhere to codes and standards such as ASME, API, and ANSI to develop precise and efficient designs tailored to your project requirements.From conceptualization to fabrication, our design process focuses on enhancing operational efficiency, minimizing environmental impact, and maximizing safety. We deliver innovative and reliable test separator designs that optimize oil and gas production processes and drive success in the industry.",
  },
  {
